...
namespace wotr_mod.Classes.Necromancer
{
    internal static class NecromancerSpellRegistry
    {
        private static readonly IReadOnlyList<ClassSpellDefinition> Spells = new[]
        {
            ...
            Spell("HarvestSoul", ModBlueprintIds.Spells.HarvestSoul, 7, SelectionRecommendation.NotRecommended),
            ...
            Spell("DeathClutch", GameBlueprintIds.Spells.DeathClutch, 8, SelectionRecommendation.NotRecommended),
