...
namespace wotr_mod.Content.Localization
{
    internal static class ModText
    {
        private static readonly Dictionary<string, string> Strings = new Dictionary<string, string>
        {
            ...
            { LocalizationIds.Mod.CleverPyromaniacDescription, "These gnomes are as dangerously fascinated by fire as pyromaniacs, but their experiments sharpen the mind instead of charm. They gain the Pyromaniac heritage benefits and replace the gnome racial +2 Charisma bonus with a +2 Intelligence bonus." },
            ...
            { LocalizationIds.Mod.ShadowGnomeHeritageDescription, "These gnomes move like living silhouettes, charming and elusive. They gain a +3 racial bonus to Charisma and a +2 racial bonus to Dexterity." },
