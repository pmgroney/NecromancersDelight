...
namespace wotr_mod.Content.Localization
{
    internal static class ModText
    {
        private static readonly Dictionary<string, string> Strings = new Dictionary<string, string>
        {
            ...
            { LocalizationIds.Mod.LivingDarknessName1, "Living Darkness I" },
            { LocalizationIds.Mod.LivingDarknessDescription1, "You call forth a 15-foot aura of living shadow centered on yourself, lasting 1 minute per caster level. You gain partial concealment (20% miss chance, stacks with other sources). Enemies within the aura take a -1 penalty to saving throws against your spells." },
            { LocalizationIds.Mod.LivingDarknessName2, "Living Darkness II" },
            { LocalizationIds.Mod.LivingDarknessDescription2, "You call forth a 20-foot aura of living shadow centered on yourself, lasting 1 minute per caster level. You gain total concealment (50% miss chance, stacks with other sources). Enemies within the aura take a -2 penalty to saving throws against your spells and become Fatigued. Your negative energy spells bypass up to 5 points of the target's energy resistance." },
            { LocalizationIds.Mod.LivingDarknessName3, "Living Darkness III" },
            ...
            { LocalizationIds.Mod.LivingDarknessName4, "Living Darkness IV" },
            ...
            { LocalizationIds.Mod.LivingDarknessShakenDescription, "The living darkness has shaken you to your core." }
        };
